...
export const ApiErrorCodes = {
  ...
  AI_CONTEXT_LIMIT: 'AI.CONTEXT_LIMIT',
  AI_CREDENTIAL_CONFLICT: 'AI.CREDENTIAL_CONFLICT',
  AI_CREDENTIAL_KEY_UNAVAILABLE: 'AI.CREDENTIAL_KEY_UNAVAILABLE',
  AI_GENERATION_ACTIVE: 'AI.GENERATION_ACTIVE',
  AI_GENERATION_INTERRUPTED: 'AI.GENERATION_INTERRUPTED',
  AI_GENERATION_TOOL_CALL_LIMIT: 'AI.GENERATION_TOOL_CALL_LIMIT',
  AI_GENERATION_TOOL_ROUND_LIMIT: 'AI.GENERATION_TOOL_ROUND_LIMIT',
  AI_GENERATION_TOOL_TOTAL_TIMEOUT: 'AI.GENERATION_TOOL_TOTAL_TIMEOUT',
  ...
  AI_RETRY_NOT_ALLOWED: 'AI.RETRY_NOT_ALLOWED',
