...
export const ApiErrorCodes = {
  ...
  AI_CUSTOM_PROVIDER_CHECK_FAILED: 'AI.CUSTOM_PROVIDER_CHECK_FAILED',
  AI_CUSTOM_PROVIDER_CONFLICT: 'AI.CUSTOM_PROVIDER_CONFLICT',
  AI_CUSTOM_PROVIDER_EXISTS: 'AI.CUSTOM_PROVIDER_EXISTS',
  AI_CUSTOM_PROVIDER_ID_CONFLICT: 'AI.CUSTOM_PROVIDER_ID_CONFLICT',
  AI_CUSTOM_PROVIDER_IN_USE: 'AI.CUSTOM_PROVIDER_IN_USE',
  AI_CUSTOM_PROVIDER_MODEL_INVALID: 'AI.CUSTOM_PROVIDER_MODEL_INVALID',
  AI_CUSTOM_PROVIDER_PROTOCOL_INVALID: 'AI.CUSTOM_PROVIDER_PROTOCOL_INVALID',
  AI_CUSTOM_PROVIDER_URL_INVALID: 'AI.CUSTOM_PROVIDER_URL_INVALID',
  AI_IDEMPOTENCY_KEY_CONFLICT: 'AI.IDEMPOTENCY_KEY_CONFLICT',
  ...
  AI_WEBHOOK_ENDPOINT_NOT_FOUND: 'AI.WEBHOOK_ENDPOINT_NOT_FOUND',
