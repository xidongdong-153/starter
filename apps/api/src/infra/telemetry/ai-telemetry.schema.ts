    ...
    'starter.ai.run': {
      ...
      endAttributes: {
        ...
        'starter.ai.error.category': {
          type: 'string',
          values: ['auth', 'upstream', 'timeout', 'cancelled', 'storage', 'tool', 'validation', 'unknown'],
          description: '错误分类',
        },
      },
    ...
    'starter.ai.model_call': {
      ...
      endAttributes: {
        ...
        'starter.ai.model_call.result': {
          type: 'string',
          values: ['succeeded', 'upstream_failed', 'auth_failed', 'timed_out', 'cancelled', 'interrupted'],
          description: '模型调用结果',
        },
