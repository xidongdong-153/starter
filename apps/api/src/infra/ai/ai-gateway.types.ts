...
export type AiModelMessage = AiModelUserMessage | AiModelAssistantMessage | AiModelToolResult
...
export type AiGatewayStopReason = 'stop' | 'length' | 'tool_use' | 'aborted' | 'error' | 'deferred'
...
export type AiGatewayErrorKind = 'aborted' | 'auth' | 'model_not_found' | 'timeout' | 'upstream'
