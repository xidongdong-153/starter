...
export const createAgentSessionRoute = createRoute({
  ...
  responses: {
    200: apiSuccessResponse(agentSessionSchema, '创建的 Agent Session', 'AgentSessionResponse'),
...
export const listAgentSessionsRoute = createRoute({
  ...
  responses: {
    200: apiSuccessResponse(agentSessionListSchema, 'Agent Session 列表', 'AgentSessionListResponse'),
    401: unauthorizedResponse,
  },
})
...
export const getAgentSessionRoute = createRoute({
  ...
  responses: {
    200: apiSuccessResponse(agentSessionSchema, 'Agent Session 详情', 'AgentSessionResponse'),
    401: unauthorizedResponse,
    404: notFoundResponse,
  },
})
...
export const updateAgentSessionRoute = createRoute({
  ...
  responses: {
    200: apiSuccessResponse(agentSessionSchema, '更新的 Agent Session', 'AgentSessionResponse'),
    400: invalidRequestResponse,
    401: unauthorizedResponse,
    404: notFoundResponse,
    409: conflictResponse,
...
export const deleteAgentSessionRoute = createRoute({
  ...
  request: { params: sessionParams },
  responses: {
    200: apiSuccessResponse(agentSessionSchema, '归档后的 Agent Session', 'AgentSessionResponse'),
    401: unauthorizedResponse,
    404: notFoundResponse,
  },
})
