 ...
 */
export function resolveUserRolesAction(before: string[], after: string[]): UserRolesAuditAction {
...
export function insertAuditEvent(tx: AuditTxLike, input: AuditEventInput): void {
