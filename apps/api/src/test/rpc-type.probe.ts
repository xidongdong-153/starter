...
type _k09 = Assert<Eq<keyof C['api']['profile']['avatar'] & '$delete', '$delete'>>
...
type _k14 = Assert<Eq<keyof C['api']['files'][':fileId'] & '$delete', '$delete'>>
type _k15 = Assert<Eq<keyof C['api']['users'] & '$get', '$get'>>
type _k16 = Assert<Eq<keyof C['api']['users'][':userId'] & '$get', '$get'>>
type _k17 = Assert<Eq<keyof C['api']['users'][':userId']['status'] & '$patch', '$patch'>>
type _k18 = Assert<Eq<keyof C['api']['me']['permissions'] & '$get', '$get'>>
type _k19 = Assert<Eq<keyof C['api']['authorization']['users'] & '$get', '$get'>>
type _k20 = Assert<Eq<keyof C['api']['authorization']['users'][':userId']['roles'] & '$put', '$put'>>
type _k21 = Assert<Eq<keyof C['api']['authorization']['roles'] & '$get', '$get'>>
type _k22 = Assert<Eq<keyof C['api']['authorization']['roles'] & '$post', '$post'>>
type _k23 = Assert<Eq<keyof C['api']['authorization']['roles'][':roleKey'] & '$patch', '$patch'>>
type _k24 = Assert<Eq<keyof C['api']['authorization']['roles'][':roleKey']['archive'] & '$post', '$post'>>
type _k25 = Assert<Eq<keyof C['api']['authorization']['roles'][':roleKey']['restore'] & '$post', '$post'>>
type _k26 = Assert<Eq<keyof C['api']['authorization']['roles'][':roleKey']['impact'] & '$get', '$get'>>
type _k27 = Assert<Eq<keyof C['api']['authorization']['permissions'][':permissionKey']['impact'] & '$get', '$get'>>
type _k28 = Assert<Eq<keyof C['api']['authorization']['roles'][':roleKey']['permissions'] & '$put', '$put'>>
type _k29 = Assert<Eq<keyof C['api']['authorization'] & 'audit-events', 'audit-events'>>
...
type AuthConfigData = InferResponseType<C['api']['config']['auth']['$get'], 200>['data']
type _h2 = Assert<
  Eq<
    AuthConfigData,
    {
...
type PublicProfileData = InferResponseType<C['api']['profiles'][':userId']['$get'], 200>['data']
...
type _h7 = Assert<Eq<UsersData['items'][number]['status'], 'active' | 'suspended'>>

// /api/users/{userId}/status: JSON body + 多状态 + data.from
type StatusReq = InferRequestType<C['api']['users'][':userId']['status']['$patch']>
type _h8 = Assert<Eq<StatusReq['json'], { status: 'active' | 'suspended' }>>
type StatusData = InferResponseType<C['api']['users'][':userId']['status']['$patch'], 200>['data']
...
type _h11 = Assert<'AUTH.UNAUTHENTICATED' extends UsersFailure['error']['code'] ? true : false>

// 动态 param 推导 roleKey
type RoleReq = InferRequestType<C['api']['authorization']['roles'][':roleKey']['$patch']>
type _h12 = Assert<Eq<RoleReq['param'], { roleKey: string }>>

// audit-events query 存在 page + data.action 包含 user.status_changed 分支
type AuditReq = InferRequestType<C['api']['authorization']['audit-events']['$get']>
type _h13 = Assert<Eq<keyof AuditReq['query'] & 'page', 'page'>>
type AuditData = InferResponseType<C['api']['authorization']['audit-events']['$get'], 200>['data']
type _h14 = Assert<'user.status_changed' extends AuditData['items'][number]['action'] ? true : false>

// ---- 3. AI 子域路由和具体类型保留 ----
type AiProvidersData = InferResponseType<C['api']['ai']['admin']['providers']['$get'], 200>['data']
...
type AiUsageData = InferResponseType<C['api']['ai']['usage']['calls']['$get'], 200>['data']
type _ai3 = Assert<'succeeded' extends AiUsageData['items'][number]['result'] ? true : false>

type SystemPromptReq = InferRequestType<C['api']['ai']['system-prompts'][':id']['$put']>
type _ai6 = Assert<Eq<SystemPromptReq['param'], { id: string }>>
type SystemPromptData = InferResponseType<C['api']['ai']['system-prompts'][':id']['$put'], 200>['data']
...
type AiSkillData = InferResponseType<C['api']['ai']['skills'][':id']['$put'], 200>['data']
type _ai10 = Assert<Eq<AiSkillData['content'], string>>

type AiSessionCreateData = InferResponseType<C['api']['ai']['sessions']['$post'], 200>['data']
...
type AiTranscriptReq = InferRequestType<C['api']['ai']['sessions'][':sessionId']['transcript']['$get']>
type _ai14 = Assert<Eq<AiTranscriptReq['param'], { sessionId: string }>>

type AiStartRunReq = InferRequestType<C['api']['ai']['sessions'][':sessionId']['runs']['$post']>
type _ai15 = Assert<Eq<AiStartRunReq['param'], { sessionId: string }>>
type _ai16 = Assert<Eq<keyof AiStartRunReq['json'] & 'input', 'input'>>
type AiRunParams = InferRequestType<C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['$get']>['param']
type _ai17 = Assert<Eq<AiRunParams, { sessionId: string; runId: string }>>
type AiRunData = InferResponseType<C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['$get'], 200>['data']
type _ai18 = Assert<Eq<keyof AiRunData & 'status', 'status'>>
type _ai19 = Assert<Eq<keyof C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['abort'] & '$post', '$post'>>
type _ai20 = Assert<Eq<keyof C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['steer'] & '$post', '$post'>>
type AiSteerReq = InferRequestType<C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['steer']['$post']>
type _ai21 = Assert<Eq<keyof AiSteerReq['json'] & 'text', 'text'>>
type _ai22 = Assert<
  Eq<keyof C['api']['ai']['sessions'][':sessionId']['runs'][':runId']['follow-ups'] & '$post', '$post'>
>
type _ai23 = Assert<Eq<keyof C['api']['ai']['sessions'][':sessionId']['active-run'] & '$get', '$get'>>
