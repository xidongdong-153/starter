...
export function createTestApp(
  ...
  deps: RuntimeDeps & {
    piAgentExecutorFactory?: (runtime: ReturnType<typeof createRuntime>) => PiAgentExecutor
  } = {},
) {
...
export async function signInWithPassword(app: ReturnType<typeof createApp>, email: string, password: string) {
...
export async function readSuccess<T>(response: Response): Promise<ApiSuccess<T>> {
