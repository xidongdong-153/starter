...
export function parseBoundedJson(json: string, maxDepth = DEFAULT_MAX_JSON_DEPTH): unknown {
  const value = JSON.parse(json) as unknown
  assertJsonDepth(value, maxDepth)
  return value
}

export function assertJsonDepth(value: unknown, maxDepth = DEFAULT_MAX_JSON_DEPTH): void {
